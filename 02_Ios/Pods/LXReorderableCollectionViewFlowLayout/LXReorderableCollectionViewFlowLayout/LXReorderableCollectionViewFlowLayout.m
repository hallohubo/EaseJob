        ...
        case UIGestureRecognizerStateEnded: {
            ...
            if (currentIndexPath) {
                ...
                [UIView
                 ...
                 animations:^{
                     __strong typeof(self) strongSelf = weakSelf;
                     if (strongSelf && self.isNeedEndAnimator) {
...
- (void)handlePanGesture:(UIPanGestureRecognizer *)gestureRecognizer {
    switch (gestureRecognizer.state) {
        ...
        case UIGestureRecognizerStateChanged: {
            ...
            if([self.delegate respondsToSelector:@selector(collectionView:didDraggingItemLayout:)])
            {
                [self.delegate collectionView:self.collectionView didDraggingItemLayout:self];
            }
