...
/********* <#注释#> *********/
@property(nonatomic,assign)BOOL isNeedEndAnimator;
...
- (void)collectionView:(UICollectionView *)collectionView didDraggingItemLayout:(UICollectionViewLayout *)collectionViewLayout ;
