...
- (void)setupSubviews
{
    ...
    [cancelBtn setTitle:NSLocalizedStringFromTable(@"取消", @"PhotoTweaks", nil) forState:UIControlStateNormal];
    ...
    [cropBtn setTitle:NSLocalizedStringFromTable(@"确定", @"PhotoTweaks", nil) forState:UIControlStateNormal];
